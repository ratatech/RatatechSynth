...
void test_mux_out(void){
	...
	/** Print output buffer */
	printOutBuff("buff_mux_out", pMovAvgOut, BUFF_SIZE);

	/** Compare output vs reference */
	TEST_ASSERT_EQUAL_INT16_ARRAY(buff_mux_ref,pMovAvgOut,BUFF_SIZE);
