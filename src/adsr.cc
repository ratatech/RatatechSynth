...
void ADSR::set_params(synth_params_t *synth_params) {
	...
	ph_inc_att = adsr_time_phinc_lut[synth_params->mux_0_out.mux_x[0]];
	ph_inc_dec = adsr_time_phinc_lut[synth_params->mux_0_out.mux_x[0]];
	ph_inc_rel = adsr_time_phinc_lut[synth_params->mux_0_out.mux_x[0]];

	sustain_level = (q15_t) (synth_params->mux_0_out.mux_x[0] * MAX_AMP) >> 12;
	sustain_level = (q15_t) ((int32_t) (synth_params->mux_0_out.mux_x[0] * MAX_AMP) >> 12);
