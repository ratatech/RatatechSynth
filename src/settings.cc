...
void init_settings(synth_params_t* synth_params, object_pool_t object_pool){
		...
		/** ADSR settings */
		synth_params->adsr_params.beta_att = adsr_beta_exp_curve_q31[60];
		synth_params->adsr_params.beta_dec = adsr_beta_exp_curve_q31[70];
		synth_params->adsr_params.beta_rel = adsr_beta_exp_curve_q31[50];
