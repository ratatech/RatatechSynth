...
void init_settings(synth_params_t* synth_params, object_pool_t object_pool){
		...
		/** ADSR settings */
		synth_params->adsr_params.beta_att = adsr_beta_exp_curve_q31[1100];
		synth_params->adsr_params.beta_dec = adsr_beta_exp_curve_q31[2000];
		synth_params->adsr_params.beta_rel = adsr_beta_exp_curve_q31[1500];
		synth_params->adsr_params.sustain_level = MAX_AMP;
		synth_params->adsr_params.ratio = 214748364;
